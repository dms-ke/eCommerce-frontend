...
import { jwtDecode } from "jwt-decode"; // 🔥 NEW: Import the JWT decoder
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Save the JWT token to localStorage (handles both standard NestJS "access_token" or simple "token")
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button 
            type="submit"
            disabled={isLoading}
            className="w-full bg-blue-600 text-white font-bold rounded-xl px-4 py-3 mt-2 hover:bg-blue-700 transition-colors disabled:opacity-70 flex justify-center items-center"
          >
            {isLoading ? (
